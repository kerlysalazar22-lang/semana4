...
El repositorio sigue la organización modular solicitada:
 
text
  
restaurante_app/
├── modelos/
│   ├── producto.py      # Define la clase Producto y sus atributos/métodos
│   └── cliente.py       # Define la clase Cliente y sus métodos de consumo
├── servicios/
│   └── restaurante.py   # Clase principal que gestiona toda la lógica del negocio
├── main.py              # Punto de entrada del programa y simulación de uso
